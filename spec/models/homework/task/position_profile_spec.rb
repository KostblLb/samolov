...
RSpec.describe Homework::Subtask::PositionProfile do
  ...
  describe 'create position profile' do
    ...
    it 'creates two profile' do
      expect(homework_progress.tasks[0].subtasks[1].reload.profile_compulsory).not_to be_nil
      expect(homework_progress.tasks[0].subtasks[1].reload.profile_desirable).not_to be_nil
